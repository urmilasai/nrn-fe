...
const CardSkeleton = ({key}: {key: number}) => {
  return (
    <div key={`${key}-skeleton`} className="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden cursor-pointer transition-transform duration-300 hover:scale-105">
